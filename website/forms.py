...
class SignUpForm(UserCreationForm):
    ...
    title = forms.CharField(label="", max_length=50,  widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Job title'}))
    experience = forms.CharField(label="", max_length=50,  widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Years of experience'}))
    ...
    class Meta:
        model = User
        fields = ('username', 'first_name', 'last_name', 'title', 'experience', 'city', 'phone', 'email', 'photo', 'password1', 'password2')
...
class AddApplicationForm(forms.ModelForm):
    ...
    title = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder": "Job title", "class":"form-control"}), label="")
